...
router.get('/', (req,res) => {
    ...
    connection.connect()
    customerquery='SELECT *  FROM orders';
  ...
  router.get('/:id', (req, res) => {
    ...
    customerquery='SELECT c.customerNumber, o.orderNumber , o.orderDate , customerName, contactFirstName, contactLastName FROM customers c INNER JOIN orders o on c.customerNumber = o.customerNumber';
